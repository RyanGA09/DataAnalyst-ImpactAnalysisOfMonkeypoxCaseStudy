# Impact Analysis of Monkeypox Case Study (Notebooks)
...
│
├── analysis_processing/                                                            # Contains the analysis & processing notebooks code
│       ├── Notebook_{start_year}_{start_month}_to_{end_year}_{end_month}.ipynb     # Notebook containing the analysis & processing code
├── visualization/                                                                  # Contains the EDA & Visualization notebooks code
│       └── Notebook_{start_year}_{start_month}_to_{end_year}_{end_month}.ipynb     # Notebook containing the EDA & visualization code
└── README.md                                                                       # Information of analysis processing & directory path
```
